...
class ServiceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_type" do
    assert_difference("ServiceType.count") do
      post service_types_url, params: { service_type: { description: @service_type.description, is_active: @service_type.is_active, is_billable: @service_type.is_billable, team_id: @service_type.team_id } }
    end
  ...
  test "should update service_type" do
    patch service_type_url(@service_type), params: { service_type: { description: @service_type.description, is_active: @service_type.is_active, is_billable: @service_type.is_billable, team_id: @service_type.team_id } }
