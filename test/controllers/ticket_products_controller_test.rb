...
class TicketProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket_product" do
    assert_difference("TicketProduct.count") do
      post ticket_products_url, params: { ticket_product: { observation: @ticket_product.observation, product_id: @ticket_product.product_id, quantity: @ticket_product.quantity, ticket_id: @ticket_product.ticket_id } }
    end
  ...
  test "should update ticket_product" do
    patch ticket_product_url(@ticket_product), params: { ticket_product: { observation: @ticket_product.observation, product_id: @ticket_product.product_id, quantity: @ticket_product.quantity, ticket_id: @ticket_product.ticket_id } }
