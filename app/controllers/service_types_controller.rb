class ServiceTypesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to service_types_path, status: :see_other, notice: "Service type was successfully destroyed." }
  ...
  private
    ...
    def service_type_params
      params.require(:service_type).permit(:description, :is_active, :is_billable, :team_id)
    end
end
