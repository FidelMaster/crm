class TicketStatusesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to ticket_statuses_path, status: :see_other, notice: "Ticket status was successfully destroyed." }
  ...
  private
    ...
    def ticket_status_params
      params.require(:ticket_status).permit(:code, :description)
    end
end
